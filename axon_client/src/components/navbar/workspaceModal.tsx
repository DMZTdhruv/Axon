...
const WorkspaceModal = ({
	...
	return (
		<div className="absolute shadow-lg animate-in shadow-2xl fade-in-0 duration-300 px-4 py-2 border-neutral-800 border backdrop-blur-2xl rounded-xl top-0 left-[105%] z-[10] w-[300px] h-auto bg-neutral-950/50">
			...
			<div>
				<div className="p-1">
					<button
						...
						className="flex group w-full relative items-center gap-3 py-1 px-2 my-[0.40rem] hover:bg-neutral-800/50 rounded-md cursor-pointer transition-colors"
					>
						<FiEdit
					...
					<button
						type="button"
						className="flex group items-center w-full gap-3 py-1 px-2 my-[0.40rem] hover:bg-neutral-800/50 rounded-md cursor-pointer transition-colors"
						onClick={() => {
					...
					<button
						className="flex w-full group items-center gap-3 py-1 px-2 my-[0.40rem] hover:bg-neutral-800/50 rounded-md cursor-pointer transition-colors"
						type="button"
						onClick={() => {
					...
					<div className="flex group items-center gap-3 py-1 px-2 my-[0.40rem] hover:bg-neutral-800/50 rounded-md cursor-pointer transition-colors">
						<FiStar
							className="text-neutral-400 group-active:scale-90 "
							size={18}
						/>
						<span className="text-sm text-neutral-300">
							Move to{" "}
							{currentWorkspace?.workspace === "main" ? "Everything" : "Main"}
						</span>
					</div>
					<div className="flex group items-center gap-3 py-1 px-2 my-[0.40rem] hover:bg-neutral-800/50 rounded-md cursor-pointer transition-colors">
						<FiCopy
					...
					<button
						type="button"
						className="flex w-full group items-center gap-3 py-1 px-2 my-[0.40rem] hover:bg-red-800/50 rounded-md cursor-pointer transition-colors"
					...
					<button
						className="flex group w-full items-center gap-3 py-1 px-2 my-[0.40rem] hover:bg-neutral-800/50 rounded-md cursor-pointer transition-colors"
						type="button"
